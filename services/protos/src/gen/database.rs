        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/database.Database/GetFileMeta",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("database.Database", "GetFileMeta"));
...
pub mod database_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/database.Database/GetFileMeta" => {
                    ...
                    struct GetFileMetaSvc<T: Database>(pub Arc<T>);
                    impl<
                        T: Database,
                    ...
                    for GetFileMetaSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Database>::get_file_meta(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: Database> tonic::server::NamedService for DatabaseServer<T> {
        const NAME: &'static str = "database.Database";
    }
}
